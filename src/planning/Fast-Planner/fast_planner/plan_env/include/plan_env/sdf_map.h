...
public:
  ...
  enum { POSE_DEPTH = 1, ODOMETRY_DEPTH = 2,  ODOMETRY_POINTS = 3,  INVALID_IDX = -10000 };

  // occupancy map management
  void resetBuffer();
  void resetBuffer(Eigen::Vector3d min, Eigen::Vector3d max);

  // void Map_ParametersUpdate();
...
private:
  ...
  void poindsOdomCallback(const sensor_msgs::PointCloud2ConstPtr& img, const nav_msgs::OdometryConstPtr& odom);
  ...
  typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, geometry_msgs::PoseStamped>
    ...
    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2, nav_msgs::Odometry>
      SyncPolicyPoindsOdom;
      
  typedef shared_ptr<message_filters::Synchronizer<SyncPolicyImagePose>> SynchronizerImagePose;
  typedef shared_ptr<message_filters::Synchronizer<SyncPolicyImageOdom>> SynchronizerImageOdom;
  typedef shared_ptr<message_filters::Synchronizer<SyncPolicyPoindsOdom>> SynchronizerPointsOdom;

  ros::NodeHandle node_;
  shared_ptr<message_filters::Subscriber<sensor_msgs::Image>> depth_sub_;
  shared_ptr<message_filters::Subscriber<geometry_msgs::PoseStamped>> pose_sub_;
  shared_ptr<message_filters::Subscriber<nav_msgs::Odometry>> odom_sub_;
  shared_ptr<message_filters::Subscriber<sensor_msgs::PointCloud2>> poinds_sub_;
  SynchronizerImagePose sync_image_pose_;
  SynchronizerImageOdom sync_image_odom_;
  SynchronizerPointsOdom sync_poinds_odom_;
