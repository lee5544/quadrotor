...
//各种定义
ros::Publisher cmd_vis_pub, pos_cmd_pub, traj_pub,local_pos_pub;
...
void cmdCallback(const ros::TimerEvent& e) 
{
  ...
  cmd.move_mode = prometheus_msgs::PositionReference::xyz_vel_yaw;  //TRAJECTORY
...
//  msg.yaw=mavYaw_;
// std::cout<<"a:"<<a_limit_des.transpose()<<std::endl;
